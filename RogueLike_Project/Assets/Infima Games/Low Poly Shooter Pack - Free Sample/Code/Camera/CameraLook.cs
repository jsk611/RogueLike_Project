    ...
    public class CameraLook : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            if (smooth)
            {
                ...
                playerCharacter.transform.localRotation = Quaternion.Slerp(playerCharacter.transform.localRotation, rotationCharacter, Time.deltaTime * interpolationSpeed);
            }
            else
            {
                //Rotate local.
                ...
                playerCharacter.transform.localRotation = (playerCharacter.transform.localRotation * rotationYaw);
